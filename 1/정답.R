...
ORD <- read_csv("C:/Users/Seung Jae Han/Dropbox/구직/Data Analyst/마켓컬리_데이터애널리스트_인턴_한승재/[마켓컬리]고객전략팀_데이터에널리스트_인턴_과제전형/1. 주문정보.csv", locale=locale('ko',encoding='euc-kr'))
COUPON <- read_csv("C:/Users/Seung Jae Han/Dropbox/구직/Data Analyst/마켓컬리_데이터애널리스트_인턴_한승재/[마켓컬리]고객전략팀_데이터에널리스트_인턴_과제전형/2. 쿠폰주문정보.csv", locale=locale('ko',encoding='euc-kr'))
RANK <- read_csv("C:/Users/Seung Jae Han/Dropbox/구직/Data Analyst/마켓컬리_데이터애널리스트_인턴_한승재/[마켓컬리]고객전략팀_데이터에널리스트_인턴_과제전형/3. 상품순위.csv", locale=locale('ko',encoding='euc-kr'))
REC <- read_csv("C:/Users/Seung Jae Han/Dropbox/구직/Data Analyst/마켓컬리_데이터애널리스트_인턴_한승재/[마켓컬리]고객전략팀_데이터에널리스트_인턴_과제전형/4. 고객별 추천상품.csv", locale=locale('ko',encoding='euc-kr'))
